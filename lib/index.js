...
function getTrelloActionType(action = {}) {
  ...
  switch (type) {
    ...
    case "updateCard":
      ...
      if (data.old && data.old.hasOwnProperty('desc')) {
        return trelloActionTypes.CHANGE_CARD_DESCRIPTION;
      }
